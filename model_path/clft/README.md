Download our CLFT model paths from [HERE](https://www.junyigu-claude.com/datasets/clft-clfcn-pretrain-models-and-waymo-dataset/) and put them in this directory. We provide five paths for different variants and modalities. 
