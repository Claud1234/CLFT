...
day_fair_train_txt = open('train_day_fair.txt', 'w')
...
for elem in rest_day_fair:
    day_fair_train_txt.write(day_fair_parent_path + elem + '\n')
day_fair_train_txt.close()


lines = open('early_stop_valid.txt').readlines()
random.shuffle(lines)
open('early_stop_valid.txt', 'w').writelines(lines)
