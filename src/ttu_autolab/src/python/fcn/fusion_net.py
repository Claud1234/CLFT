...
class FusionNet(nn.Module):
    def __init__(self):
        ...
        self.backbone_rgb, \
        self.intermediate_single_rgb, \
        self.classifier_rgb = self.get_split_model()
        
        self.backbone_lidar, \
        self.intermediate_single_lidar, \
        self.classifier_lidar = self.get_split_model()
        
        _, \
        self.intermediate_single_fusion, \
        self.classifier_fusion = self.get_split_model(isFusion=True)
